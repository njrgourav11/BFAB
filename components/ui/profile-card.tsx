...
export function ProfileCard({
    ...
    return (
        <motion.div
            ...
            className={cn(
                "relative w-80 h-96 rounded-3xl border border-border/20 text-card-foreground overflow-hidden shadow-xl shadow-black/5 cursor-pointer group backdrop-blur-sm bg-white dark:bg-slate-900",

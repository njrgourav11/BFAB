      ...
      <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-purple-100">We're here to help! Reach out to us anytime</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            {contactMethods.map((method, index) => (
              ...
              >
                ...
                <p className="text-lg font-semibold text-blue-600">{method.details}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              <h2 className="text-3xl font-bold text-gray-800 mb-6">✉️ Send us a Message</h2>
              {submitted && (
                <motion.div
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-lg transition flex items-center justify-center gap-2"
                >
                  <Send size={20} />
                  Send Message
                </motion.button>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg shadow-lg p-8 mb-6">
              ...
              >
                ...
                <h4 className="text-lg font-bold text-gray-800 mb-2">Award Winning</h4>
                <p className="text-sm text-gray-600">Trusted by 50,000+ pet owners</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
            ...
            {faqItems.map((item, index) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 transition"
                >
                ...
                >
                  <div className="p-5 bg-gradient-to-r from-blue-50 to-purple-50 border-t-2 border-gray-200">
